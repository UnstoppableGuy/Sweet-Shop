...
namespace SweetShop.Controllers
{
    ...
    public class ProductReviewController : ControllerBase
    {
        ...
        // [HttpPut("Update")]
        // public IActionResult Put(Guid id, Guid productid, Guid userid, string text, string rating)
        // {
        //     try
        //     {
        //         db.UpdateProductReview(id, productid,userid, text, float.Parse(rating));
        //     }
        //     catch
        //     {
        //         return new BadRequestObjectResult(new ProductReview());
        //     }
        //     return new OkResult();
        // }
    }
