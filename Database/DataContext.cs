...
namespace SweetShop.Database
{
    ...
    {
        private static readonly string connectionString = "Data Source=SQL5105.site4now.net;Initial Catalog=db_a8f19d_sweetshop;User Id=db_a8f19d_sweetshop_admin;Password=SpecKlad070107;";
        ...
        {
            var count = ReadProcedure<int>("GetCountProduct", new Dictionary<string, object>
            {
                {"@id", id }
            });
            Console.WriteLine($"GetCountProduct {count[0]}");
            return count[0];
        }

        public int GetCountProduct()
        {
            var count = ReadProcedure<int>("CountProduct", new Dictionary<string, object>
            {
            });
            Console.WriteLine($"CountProduct {count[0]}");
            return count[0];
        }
