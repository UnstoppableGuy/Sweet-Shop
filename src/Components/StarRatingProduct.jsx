...
import { selectRating } from '../redux/slices/detailsProductSlice';

export const StarRatingProduct = ({index}) => {

    const rating = useSelector(selectRating);

  return (
    <svg className='star-display' xmlns="http://www.w3.org/2000/svg" id="Icons" viewBox="0 0 24 24" >
        <defs>
