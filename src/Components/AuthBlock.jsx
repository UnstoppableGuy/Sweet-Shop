...
export const AuthBlock = () => {
    ...
    return (
    <div className="container__right-auth">
...

        {
            ...
            <NavLink to={`/profile`} className='item'>
                <svg
                    ...
                    <circle cx="25" cy="25" fill="none" r="24" stroke="#000000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="1"/>
                    <rect fill="none" height="1" width="1"/>
                    <path   
                        xmlns="http://www.w3.org/2000/svg" 
